...
import graeme.hosford.event.manager.business.injection.BusinessLayerInitializer
import graeme.hosford.event.manager.business.injection.InternalBusinessComponent

/**
 * Contains business layer specific initialization for the main sample [Application] concrete class.
 */
abstract class EventManagerBusinessApplication : Application() {
